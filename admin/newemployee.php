                        ...
                        <form>
                            ...
                            <div class="modal-body row">
                                <div class="col-md-6">
                                    ...
                                    <div class="form-check">
                                        <input type="checkbox" class="form-check-input" value="">Customer Officer
                                    </div>
                                    <div class="form-check">
                                ...
                                <div class="col-md-6">
                                    <div class="form-check">
                                        <input type="checkbox" class="form-check-input" value="">Graphic Operator
                                    </div>
                                    <div class="form-check">
                                    ...
                                    <div class="form-check">
                                        <input type="checkbox" class="form-check-input" value="">Production Manager
                                    </div>
                                    <div class="form-check">
                                        <input type="checkbox" class="form-check-input" value="">Setup Technician
                                    </div>
                                    <div class="form-check">
                                        <input type="checkbox" class="form-check-input" value="">Slomo Operator
                                    </div>
                                    <div class="form-check">
                                        <input type="checkbox" class="form-check-input" value="">Technical Assistant
                                    </div>
                                    <div class="form-check">
